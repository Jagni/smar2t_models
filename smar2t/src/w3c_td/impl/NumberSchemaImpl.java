 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.NumberSchemaImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link w3c_td.impl.NumberSchemaImpl#getMaximum <em>Maximum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberSchemaImpl extends DataSchemaImpl implements NumberSchema {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.NUMBER_SCHEMA;
	}
	...
	public void setMinimum(double newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.NUMBER_SCHEMA__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setMaximum(double newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.NUMBER_SCHEMA__MAXIMUM, oldMaximum, maximum));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.NUMBER_SCHEMA__MINIMUM:
				return getMinimum();
			case W3c_tdPackage.NUMBER_SCHEMA__MAXIMUM:
				return getMaximum();
		}
