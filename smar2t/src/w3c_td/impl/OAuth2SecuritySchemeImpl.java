 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.OAuth2SecuritySchemeImpl#getAuthorization <em>Authorization</em>}</li>
 *   <li>{@link w3c_td.impl.OAuth2SecuritySchemeImpl#getToken <em>Token</em>}</li>
 *   <li>{@link w3c_td.impl.OAuth2SecuritySchemeImpl#getRefresh <em>Refresh</em>}</li>
 *   <li>{@link w3c_td.impl.OAuth2SecuritySchemeImpl#getScopes <em>Scopes</em>}</li>
 *   <li>{@link w3c_td.impl.OAuth2SecuritySchemeImpl#getFlow <em>Flow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OAuth2SecuritySchemeImpl extends SecuritySchemeImpl implements OAuth2SecurityScheme {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.OAUTH2_SECURITY_SCHEME;
	}
	...
	public void setAuthorization(String newAuthorization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.OAUTH2_SECURITY_SCHEME__AUTHORIZATION, oldAuthorization, authorization));
	}
	...
	public void setToken(String newToken) {
		...
		token = newToken;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.OAUTH2_SECURITY_SCHEME__TOKEN, oldToken, token));
	}
	...
	public void setRefresh(String newRefresh) {
		...
		refresh = newRefresh;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.OAUTH2_SECURITY_SCHEME__REFRESH, oldRefresh, refresh));
	}
	...
	public void setScopes(String newScopes) {
		...
		scopes = newScopes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.OAUTH2_SECURITY_SCHEME__SCOPES, oldScopes, scopes));
	}
	...
	public void setFlow(String newFlow) {
		...
		flow = newFlow;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.OAUTH2_SECURITY_SCHEME__FLOW, oldFlow, flow));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.OAUTH2_SECURITY_SCHEME__AUTHORIZATION:
				return getAuthorization();
			case W3c_tdPackage.OAUTH2_SECURITY_SCHEME__TOKEN:
				return getToken();
			case W3c_tdPackage.OAUTH2_SECURITY_SCHEME__REFRESH:
				return getRefresh();
			case W3c_tdPackage.OAUTH2_SECURITY_SCHEME__SCOPES:
				return getScopes();
			case W3c_tdPackage.OAUTH2_SECURITY_SCHEME__FLOW:
				return getFlow();
		}
