 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.ObjectSchemaImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link w3c_td.impl.ObjectSchemaImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectSchemaImpl extends DataSchemaImpl implements ObjectSchema {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.OBJECT_SCHEMA;
	}
	...
	public void setRequired(String newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.OBJECT_SCHEMA__REQUIRED, oldRequired, required));
	}
	...
	public EList<DataSchema> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<DataSchema>(DataSchema.class, this, W3c_tdPackage.OBJECT_SCHEMA__PROPERTIES);
		}
		return properties;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case W3c_tdPackage.OBJECT_SCHEMA__PROPERTIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.OBJECT_SCHEMA__REQUIRED:
				return getRequired();
			case W3c_tdPackage.OBJECT_SCHEMA__PROPERTIES:
