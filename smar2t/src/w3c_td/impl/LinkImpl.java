 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.LinkImpl#getHref <em>Href</em>}</li>
 *   <li>{@link w3c_td.impl.LinkImpl#getType <em>Type</em>}</li>
 *   <li>{@link w3c_td.impl.LinkImpl#getRel <em>Rel</em>}</li>
 *   <li>{@link w3c_td.impl.LinkImpl#getAnchor <em>Anchor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.LINK;
	}
	...
	public void setHref(String newHref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.LINK__HREF, oldHref, href));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.LINK__TYPE, oldType, type));
	}
	...
	public void setRel(String newRel) {
		...
		rel = newRel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.LINK__REL, oldRel, rel));
	}
	...
	public void setAnchor(String newAnchor) {
		...
		anchor = newAnchor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.LINK__ANCHOR, oldAnchor, anchor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.LINK__HREF:
				return getHref();
			case W3c_tdPackage.LINK__TYPE:
				return getType();
			case W3c_tdPackage.LINK__REL:
				return getRel();
			case W3c_tdPackage.LINK__ANCHOR:
				return getAnchor();
		}
