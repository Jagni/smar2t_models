 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.PropertyAffordanceImpl#isObservable <em>Observable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyAffordanceImpl extends InteractionAffordanceImpl implements PropertyAffordance {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.PROPERTY_AFFORDANCE;
	}
	...
	public void setObservable(boolean newObservable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.PROPERTY_AFFORDANCE__OBSERVABLE, oldObservable, observable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.PROPERTY_AFFORDANCE__OBSERVABLE:
				return isObservable();
		}
