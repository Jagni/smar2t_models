 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.PoPSecuritySchemeImpl#getAuthorization <em>Authorization</em>}</li>
 *   <li>{@link w3c_td.impl.PoPSecuritySchemeImpl#getAlg <em>Alg</em>}</li>
 *   <li>{@link w3c_td.impl.PoPSecuritySchemeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link w3c_td.impl.PoPSecuritySchemeImpl#getIn <em>In</em>}</li>
 *   <li>{@link w3c_td.impl.PoPSecuritySchemeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PoPSecuritySchemeImpl extends SecuritySchemeImpl implements PoPSecurityScheme {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.PO_PSECURITY_SCHEME;
	}
	...
	public void setAuthorization(String newAuthorization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.PO_PSECURITY_SCHEME__AUTHORIZATION, oldAuthorization, authorization));
	}
	...
	public void setAlg(String newAlg) {
		...
		alg = newAlg;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.PO_PSECURITY_SCHEME__ALG, oldAlg, alg));
	}
	...
	public void setFormat(String newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.PO_PSECURITY_SCHEME__FORMAT, oldFormat, format));
	}
	...
	public void setIn(String newIn) {
		...
		in = newIn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.PO_PSECURITY_SCHEME__IN, oldIn, in));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.PO_PSECURITY_SCHEME__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.PO_PSECURITY_SCHEME__AUTHORIZATION:
				return getAuthorization();
			case W3c_tdPackage.PO_PSECURITY_SCHEME__ALG:
				return getAlg();
			case W3c_tdPackage.PO_PSECURITY_SCHEME__FORMAT:
				return getFormat();
			case W3c_tdPackage.PO_PSECURITY_SCHEME__IN:
				return getIn();
			case W3c_tdPackage.PO_PSECURITY_SCHEME__NAME:
				return getName();
		}
