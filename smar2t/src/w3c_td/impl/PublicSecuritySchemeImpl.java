 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.PublicSecuritySchemeImpl#getIdentity <em>Identity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PublicSecuritySchemeImpl extends SecuritySchemeImpl implements PublicSecurityScheme {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.PUBLIC_SECURITY_SCHEME;
	}
	...
	public void setIdentity(String newIdentity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.PUBLIC_SECURITY_SCHEME__IDENTITY, oldIdentity, identity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.PUBLIC_SECURITY_SCHEME__IDENTITY:
				return getIdentity();
		}
