 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.APIKeySecuritySchemeImpl#getIn <em>In</em>}</li>
 *   <li>{@link w3c_td.impl.APIKeySecuritySchemeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class APIKeySecuritySchemeImpl extends SecuritySchemeImpl implements APIKeySecurityScheme {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.API_KEY_SECURITY_SCHEME;
	}
	...
	public void setIn(String newIn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.API_KEY_SECURITY_SCHEME__IN, oldIn, in));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.API_KEY_SECURITY_SCHEME__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.API_KEY_SECURITY_SCHEME__IN:
				return getIn();
			case W3c_tdPackage.API_KEY_SECURITY_SCHEME__NAME:
				return getName();
		}
