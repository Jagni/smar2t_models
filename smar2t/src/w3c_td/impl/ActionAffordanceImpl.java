 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.ActionAffordanceImpl#isSafe <em>Safe</em>}</li>
 *   <li>{@link w3c_td.impl.ActionAffordanceImpl#isIdempotent <em>Idempotent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionAffordanceImpl extends InteractionAffordanceImpl implements ActionAffordance {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.ACTION_AFFORDANCE;
	}
	...
	public void setSafe(boolean newSafe) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.ACTION_AFFORDANCE__SAFE, oldSafe, safe));
	}
	...
	public void setIdempotent(boolean newIdempotent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.ACTION_AFFORDANCE__IDEMPOTENT, oldIdempotent, idempotent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.ACTION_AFFORDANCE__SAFE:
				return isSafe();
			case W3c_tdPackage.ACTION_AFFORDANCE__IDEMPOTENT:
				return isIdempotent();
		}
