 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.impl.IntegerSchemaImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link w3c_td.impl.IntegerSchemaImpl#getMaximum <em>Maximum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerSchemaImpl extends DataSchemaImpl implements IntegerSchema {
	...
	protected EClass eStaticClass() {
		return W3c_tdPackage.Literals.INTEGER_SCHEMA;
	}
	...
	public void setMinimum(int newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.INTEGER_SCHEMA__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setMaximum(int newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, W3c_tdPackage.INTEGER_SCHEMA__MAXIMUM, oldMaximum, maximum));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case W3c_tdPackage.INTEGER_SCHEMA__MINIMUM:
				return getMinimum();
			case W3c_tdPackage.INTEGER_SCHEMA__MAXIMUM:
				return getMaximum();
		}
