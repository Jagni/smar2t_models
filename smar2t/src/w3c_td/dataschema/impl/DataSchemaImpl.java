 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getSemanticType <em>Semantic Type</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getType <em>Type</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getOneOf <em>One Of</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getTitles <em>Titles</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getDescriptions <em>Descriptions</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getConst <em>Const</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#isWriteOnly <em>Write Only</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.DataSchemaImpl#getFormat <em>Format</em>}</li>
 * </ul>
 *
 * @generated
 */
