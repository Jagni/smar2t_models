...
import w3c_td.dataschema.ArraySchema;
import w3c_td.dataschema.BooleanSchema;
import w3c_td.dataschema.DataSchema;
import w3c_td.dataschema.DataschemaFactory;
import w3c_td.dataschema.DataschemaPackage;
import w3c_td.dataschema.IntegerSchema;
import w3c_td.dataschema.NewEnum1;
import w3c_td.dataschema.NullSchema;
import w3c_td.dataschema.NumberSchema;
import w3c_td.dataschema.ObjectSchema;
import w3c_td.dataschema.StringSchema;
...
import w3c_td.security.impl.SecurityPackageImpl;
...
public class DataschemaPackageImpl extends EPackageImpl implements DataschemaPackage {
	 ...
	 * @see w3c_td.dataschema.DataschemaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getDataSchema_Titles(), theCorePackage.getMultiLanguage(), null, "titles", null, 0, -1, DataSchema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataSchema_Descriptions(), theCorePackage.getMultiLanguage(), null, "descriptions", null, 0, -1, DataSchema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
