 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.dataschema.impl.ArraySchemaImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.ArraySchemaImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link w3c_td.dataschema.impl.ArraySchemaImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArraySchemaImpl extends DataSchemaImpl implements ArraySchema {
	...
	protected EClass eStaticClass() {
		return DataschemaPackage.Literals.ARRAY_SCHEMA;
	}
	...
	public void setMinItems(long newMinItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataschemaPackage.ARRAY_SCHEMA__MIN_ITEMS, oldMinItems, minItems));
	}
	...
	public void setMaxItems(long newMaxItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataschemaPackage.ARRAY_SCHEMA__MAX_ITEMS, oldMaxItems, maxItems));
	}
	...
	public EList<DataSchema> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<DataSchema>(DataSchema.class, this, DataschemaPackage.ARRAY_SCHEMA__ITEMS);
		}
		return items;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataschemaPackage.ARRAY_SCHEMA__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataschemaPackage.ARRAY_SCHEMA__MIN_ITEMS:
				return getMinItems();
			case DataschemaPackage.ARRAY_SCHEMA__MAX_ITEMS:
				return getMaxItems();
			case DataschemaPackage.ARRAY_SCHEMA__ITEMS:
				return getItems();
		}
