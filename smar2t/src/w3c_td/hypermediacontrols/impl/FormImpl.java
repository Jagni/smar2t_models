/**
 */
package w3c_td.hypermediacontrols.impl;
...
import w3c_td.hypermediacontrols.ExpectedResponse;
 ...
 * </p>
 * <ul>
 *   <li>{@link w3c_td.hypermediacontrols.impl.FormImpl#getOp <em>Op</em>}</li>
 *   <li>{@link w3c_td.hypermediacontrols.impl.FormImpl#getHref <em>Href</em>}</li>
 *   <li>{@link w3c_td.hypermediacontrols.impl.FormImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link w3c_td.hypermediacontrols.impl.FormImpl#getContentCoding <em>Content Coding</em>}</li>
 *   <li>{@link w3c_td.hypermediacontrols.impl.FormImpl#getSubprotocol <em>Subprotocol</em>}</li>
 *   <li>{@link w3c_td.hypermediacontrols.impl.FormImpl#getSecurity <em>Security</em>}</li>
 *   <li>{@link w3c_td.hypermediacontrols.impl.FormImpl#getScopes <em>Scopes</em>}</li>
 *   <li>{@link w3c_td.hypermediacontrols.impl.FormImpl#getResponse <em>Response</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FormImpl extends MinimalEObjectImpl.Container implements Form {
	...
	protected EClass eStaticClass() {
		return HypermediacontrolsPackage.Literals.FORM;
	}
	...
	public EList<String> getOp() {
		if (op == null) {
			op = new EDataTypeUniqueEList<String>(String.class, this, HypermediacontrolsPackage.FORM__OP);
		}
		return op;
	}
	...
	public void setHref(String newHref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HypermediacontrolsPackage.FORM__HREF, oldHref, href));
	}
	...
	public void setContentType(String newContentType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HypermediacontrolsPackage.FORM__CONTENT_TYPE, oldContentType, contentType));
	}
	...
	public void setContentCoding(String newContentCoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HypermediacontrolsPackage.FORM__CONTENT_CODING, oldContentCoding, contentCoding));
	}
	...
	public void setSubprotocol(String newSubprotocol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HypermediacontrolsPackage.FORM__SUBPROTOCOL, oldSubprotocol, subprotocol));
	}
	...
	public void setSecurity(String newSecurity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HypermediacontrolsPackage.FORM__SECURITY, oldSecurity, security));
	}
	...
	public void setScopes(String newScopes) {
		...
		scopes = newScopes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HypermediacontrolsPackage.FORM__SCOPES, oldScopes, scopes));
	}
	...
	public ExpectedResponse getResponse() {
		if (response != null && response.eIsProxy()) {
			...
			if (response != oldResponse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HypermediacontrolsPackage.FORM__RESPONSE, oldResponse, response));
			}
		}
		return response;
	}
	...
	public void setResponse(ExpectedResponse newResponse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HypermediacontrolsPackage.FORM__RESPONSE, oldResponse, response));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HypermediacontrolsPackage.FORM__OP:
				return getOp();
			case HypermediacontrolsPackage.FORM__HREF:
				return getHref();
			case HypermediacontrolsPackage.FORM__CONTENT_TYPE:
				return getContentType();
			case HypermediacontrolsPackage.FORM__CONTENT_CODING:
				return getContentCoding();
			case HypermediacontrolsPackage.FORM__SUBPROTOCOL:
				return getSubprotocol();
			case HypermediacontrolsPackage.FORM__SECURITY:
				return getSecurity();
			case HypermediacontrolsPackage.FORM__SCOPES:
				return getScopes();
			case HypermediacontrolsPackage.FORM__RESPONSE:
