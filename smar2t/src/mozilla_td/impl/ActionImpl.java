...
public class ActionImpl extends MinimalEObjectImpl.Container implements Action {
	...
	protected EClass eStaticClass() {
		return Mozilla_tdPackage.Literals.ACTION;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mozilla_tdPackage.ACTION__TITLE, oldTitle, title));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Mozilla_tdPackage.ACTION__DESCRIPTION, oldDescription, description));
	}
