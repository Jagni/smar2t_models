 ...
 * @generated
 */
public class Mozilla_tdFactoryImpl extends EFactoryImpl implements Mozilla_tdFactory {
	/**
	 ...
	 * @generated
	 */
	public static Mozilla_tdFactory init() {
		try {
			Mozilla_tdFactory theMozilla_tdFactory = (Mozilla_tdFactory)EPackage.Registry.INSTANCE.getEFactory(Mozilla_tdPackage.eNS_URI);
			if (theMozilla_tdFactory != null) {
				return theMozilla_tdFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new Mozilla_tdFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case Mozilla_tdPackage.THING: return createThing();
			case Mozilla_tdPackage.ATTRIBUTE: return createAttribute();
			case Mozilla_tdPackage.LINK: return createLink();
			case Mozilla_tdPackage.ACTION: return createAction();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case Mozilla_tdPackage.PRIMITIVE_TYPE:
				return createPrimitiveTypeFromString(eDataType, initialValue);
			case Mozilla_tdPackage.RELATIONSHIP:
	 ...
	 * @generated
	 */
	public Mozilla_tdPackage getMozilla_tdPackage() {
		return (Mozilla_tdPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static Mozilla_tdPackage getPackage() {
		return Mozilla_tdPackage.eINSTANCE;
	}

} //Mozilla_tdFactoryImpl
