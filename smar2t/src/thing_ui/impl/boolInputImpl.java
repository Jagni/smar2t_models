 ...
 * </p>
 * <ul>
 *   <li>{@link thing_ui.impl.boolInputImpl#getInputType <em>Input Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class boolInputImpl extends InputImpl implements boolInput {
	...
	protected EClass eStaticClass() {
		return Thing_uiPackage.Literals.BOOL_INPUT;
	}
	...
	public void setInputType(BoolInputType newInputType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Thing_uiPackage.BOOL_INPUT__INPUT_TYPE, oldInputType, inputType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Thing_uiPackage.BOOL_INPUT__INPUT_TYPE:
				return getInputType();
		}
