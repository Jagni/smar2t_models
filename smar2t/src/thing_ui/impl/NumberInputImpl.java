 ...
 * </p>
 * <ul>
 *   <li>{@link thing_ui.impl.NumberInputImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link thing_ui.impl.NumberInputImpl#getMinimumLabel <em>Minimum Label</em>}</li>
 *   <li>{@link thing_ui.impl.NumberInputImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link thing_ui.impl.NumberInputImpl#getMaximumLabel <em>Maximum Label</em>}</li>
 *   <li>{@link thing_ui.impl.NumberInputImpl#getInputType <em>Input Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberInputImpl extends InputImpl implements NumberInput {
	...
	protected EClass eStaticClass() {
		return Thing_uiPackage.Literals.NUMBER_INPUT;
	}
	...
	public void setMinimum(double newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Thing_uiPackage.NUMBER_INPUT__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setMinimumLabel(String newMinimumLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Thing_uiPackage.NUMBER_INPUT__MINIMUM_LABEL, oldMinimumLabel, minimumLabel));
	}
	...
	public void setMaximum(double newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Thing_uiPackage.NUMBER_INPUT__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setMaximumLabel(String newMaximumLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Thing_uiPackage.NUMBER_INPUT__MAXIMUM_LABEL, oldMaximumLabel, maximumLabel));
	}
	...
	public void setInputType(NumberInputType newInputType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Thing_uiPackage.NUMBER_INPUT__INPUT_TYPE, oldInputType, inputType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Thing_uiPackage.NUMBER_INPUT__MINIMUM:
				return getMinimum();
			case Thing_uiPackage.NUMBER_INPUT__MINIMUM_LABEL:
				return getMinimumLabel();
			case Thing_uiPackage.NUMBER_INPUT__MAXIMUM:
				return getMaximum();
			case Thing_uiPackage.NUMBER_INPUT__MAXIMUM_LABEL:
				return getMaximumLabel();
			case Thing_uiPackage.NUMBER_INPUT__INPUT_TYPE:
				return getInputType();
		}
