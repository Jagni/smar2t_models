 ...
 * </p>
 * <ul>
 *   <li>{@link thing_ui.core.impl.ResourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link thing_ui.core.impl.ResourceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link thing_ui.core.impl.ResourceImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link thing_ui.core.impl.ResourceImpl#getForm <em>Form</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceImpl extends MinimalEObjectImpl.Container implements Resource {
	...
	public void setIcon(String newIcon) {
		...
		icon = newIcon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RESOURCE__ICON, oldIcon, icon));
	}
	...
	public Form getForm() {
		if (form != null && form.eIsProxy()) {
			...
			if (form != oldForm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.RESOURCE__FORM, oldForm, form));
			}
		}
		return form;
	}
	...
	public void setForm(Form newForm) {
		...
		form = newForm;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RESOURCE__FORM, oldForm, form));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CorePackage.RESOURCE__ICON:
				return getIcon();
			case CorePackage.RESOURCE__FORM:
