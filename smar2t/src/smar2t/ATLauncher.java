...
public class ATLauncher {	
	...
	public Model w3c2ui(String inModelPath, String transformationDir, String transformationModule){
		...
		env.registerMetaModel(inputMetamodelName, inMetamodel);
		...
		env.registerMetaModel(outputMetamodelName, outMetamodel);
	 ...
	 * 
	 */
	public void registerInputMetamodel(String inputMetamodelPath, String inputMetamodelName){	
		inputMetamodelNsURI = lazyMetamodelRegistration(inputMetamodelPath);
		this.inputMetamodelName = inputMetamodelName;
	}

	public void registerOutputMetamodel(String outputMetamodelPath, String outputMetamodelName){
