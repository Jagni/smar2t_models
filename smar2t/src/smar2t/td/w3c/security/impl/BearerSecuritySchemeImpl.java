...
import smar2t.td.w3c.security.BearerSecurityScheme;
 ...
 * </p>
 * <ul>
 *   <li>{@link smar2t.td.w3c.security.impl.BearerSecuritySchemeImpl#getAuthorization <em>Authorization</em>}</li>
 *   <li>{@link smar2t.td.w3c.security.impl.BearerSecuritySchemeImpl#getAlg <em>Alg</em>}</li>
 *   <li>{@link smar2t.td.w3c.security.impl.BearerSecuritySchemeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link smar2t.td.w3c.security.impl.BearerSecuritySchemeImpl#getIn <em>In</em>}</li>
 *   <li>{@link smar2t.td.w3c.security.impl.BearerSecuritySchemeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BearerSecuritySchemeImpl extends SecuritySchemeImpl implements BearerSecurityScheme {
	...
	protected EClass eStaticClass() {
		return SecurityPackage.Literals.BEARER_SECURITY_SCHEME;
	}
	...
	public void setAuthorization(String newAuthorization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.BEARER_SECURITY_SCHEME__AUTHORIZATION, oldAuthorization, authorization));
	}
	...
	public void setAlg(String newAlg) {
		...
		alg = newAlg;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.BEARER_SECURITY_SCHEME__ALG, oldAlg, alg));
	}
	...
	public void setFormat(String newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.BEARER_SECURITY_SCHEME__FORMAT, oldFormat, format));
	}
	...
	public void setIn(String newIn) {
		...
		in = newIn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.BEARER_SECURITY_SCHEME__IN, oldIn, in));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.BEARER_SECURITY_SCHEME__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SecurityPackage.BEARER_SECURITY_SCHEME__AUTHORIZATION:
				return getAuthorization();
			case SecurityPackage.BEARER_SECURITY_SCHEME__ALG:
				return getAlg();
			case SecurityPackage.BEARER_SECURITY_SCHEME__FORMAT:
				return getFormat();
			case SecurityPackage.BEARER_SECURITY_SCHEME__IN:
				return getIn();
			case SecurityPackage.BEARER_SECURITY_SCHEME__NAME:
				return getName();
		}
