 ...
 * </p>
 * <ul>
 *   <li>{@link smar2t.td.w3c.security.impl.PSKSecuritySchemeImpl#getIdentity <em>Identity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PSKSecuritySchemeImpl extends SecuritySchemeImpl implements PSKSecurityScheme {
	...
	protected EClass eStaticClass() {
		return SecurityPackage.Literals.PSK_SECURITY_SCHEME;
	}
	...
	public void setIdentity(String newIdentity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.PSK_SECURITY_SCHEME__IDENTITY, oldIdentity, identity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SecurityPackage.PSK_SECURITY_SCHEME__IDENTITY:
				return getIdentity();
		}
