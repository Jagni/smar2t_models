 ...
 * </p>
 * <ul>
 *   <li>{@link smar2t.td.w3c.core.impl.VersionInfoImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionInfoImpl extends MinimalEObjectImpl.Container implements VersionInfo {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.VERSION_INFO;
	}
	...
	public void setInstance(String newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VERSION_INFO__INSTANCE, oldInstance, instance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.VERSION_INFO__INSTANCE:
				return getInstance();
		}
